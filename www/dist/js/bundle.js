...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_App2.default, null), document.querySelector('#navigation'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Container2 = __webpack_require__(167);
	    ...
	    _createClass(App, [{
	                ...
	                if (data.status === 'connected') {
	                    openFB.api({
	                        ...
	                        success: function success(data) {
	                            ...
	                            socket.emit('createUpdateUser', user, function (newUser) {
	                                window.currentUser = newUser;
	                                _phonepack.Navigation.changePage('mainNav', 'Home');
	                            });
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                _phonepack.Navigation,
	                { 'default': 'Login', name: 'mainNav', beforePage: this.beforePage.bind(this) },
	                _react2.default.createElement(_phonepack.Pages, { name: 'Home', component: _Home2.default }),
	                _react2.default.createElement(_phonepack.Pages, { name: 'Compose', component: _Compose2.default }),
	                _react2.default.createElement(_phonepack.Pages, { name: 'FindImage', component: _FindImage2.default }),
	                _react2.default.createElement(_phonepack.Pages, { name: 'Comments', component: _Comments2.default }),
	                _react2.default.createElement(_phonepack.Pages, { name: 'Notifications', component: _Notifications2.default }),
	                _react2.default.createElement(_phonepack.Pages, { name: 'Login', component: _Login2.default })
	            );
	        }
	    }]);
	    ...
	    _createClass(Container, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.unsubscribe = _store2.default.subscribe(function () {
	                if (_this2.getState) _this2.setState(_this2.getState.call(_this2));
	            });
	        }
	    }, {
	        ...
	        key: 'changePage',
	        value: function changePage(navigation, component, params) {
	            _phonepack.Navigation.changePage(navigation, component, params);
	        }
	    }, {
	        key: 'pushPage',
	        value: function pushPage(navigation, component, params, animation) {
	            _phonepack.Navigation.push(navigation, component, params, animation);
	        }
	    }, {
	        key: 'closeCurrentPage',
	        value: function closeCurrentPage(navigation) {
	            _phonepack.Navigation.closeCurrentPage(navigation);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _notificationReducer = __webpack_require__(183);

	var _notificationReducer2 = _interopRequireDefault(_notificationReducer);

	var _postReducer = __webpack_require__(184);
	...
	function postReducer() {
	    ...
	    switch (action.type) {
	        case 'GET_POSTS':
	            return action.posts;
	        case 'CREATE_POST':
	            return [action.post].concat(_toConsumableArray(posts));
	        case 'LIKE_POST':
	        ...
	        case 'COMPLETE_TODO':
	            return posts.map(function (todo) {
	                return todo.id === action.id ? Object.assign({}, todo, {
	                    completed: !todo.completed
	                }) : todo;
	            });
	        case 'DELETE_TODO':
	            return posts.filter(function (todo) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Cell = exports.Row = exports.View = exports.SideMenu = exports.Content = exports.Icon = exports.Input = exports.ButtonIcon = exports.Button = exports.ListItem = exports.List = exports.FooterTitle = exports.SubFooter = exports.FooterButton = exports.Footer = exports.HeaderTitle = exports.HeaderButton = exports.SubHeader = exports.Header = exports.Pages = exports.Navigation = undefined;

	var _Pages = __webpack_require__(186);

	var _Content = __webpack_require__(187);

	var _Content2 = _interopRequireDefault(_Content);

	var _SideMenu = __webpack_require__(189);
	...
	exports.Navigation = _Pages.Navigation;
	exports.Pages = _Pages.Pages;
	exports.Header = _Header.Header;
	exports.SubHeader = _Header.SubHeader;
	exports.HeaderButton = _Header.HeaderButton;
	exports.HeaderTitle = _Header.HeaderTitle;
	exports.Footer = _Footer.Footer;
	exports.FooterButton = _Footer.FooterButton;
	exports.SubFooter = _Footer.SubFooter;
	exports.FooterTitle = _Footer.FooterTitle;
	exports.List = _List.List;
	exports.ListItem = _List.ListItem;
	exports.Button = _Button.Button;
	exports.ButtonIcon = _Button.ButtonIcon;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Pages = exports.Navigation = undefined;
	    ...
	    _createClass(Navigation, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _react2.default.Children.map(this.props.children, function (e) {
	                _this2.components[e.props.name] = e.props.component;
	            });
	            ...
	            if (this.props.default) {
	                if (this.props.beforePage) {
	                    this.props.beforePage(function () {
	                        _this2.changePage.call(_this2, _this2.props.default);
	                    });
	                } else {
	        ...
	        value: function push(name, params) {
	            var animation = arguments.length <= 2 || arguments[2] === undefined ? 'pages--normal' : arguments[2];
	            ...
	            (0, _reactDom.render)(_react2.default.createElement(Component, _extends({}, this.props.props, params)), element);

	            var pages = element.querySelector('.pages');
	        ...
	        key: 'changePage',
	        value: function changePage(name, params) {
	            var animation = arguments.length <= 2 || arguments[2] === undefined ? 'pages--normal' : arguments[2];
	            ...
	            this.refs.navigation.appendChild(element);
	            (0, _reactDom.render)(_react2.default.createElement(Component, this.props.props), element);
	        }
	    }, {
	        key: 'closeCurrentPage',
	        value: function closeCurrentPage() {
	            ...
	            var removeDomPage = function removeDomPage() {
	                ...
	                (0, _reactDom.unmountComponentAtNode)(_this3.currentPage.element);
	                _this3.currentPage.element.remove();

	                _this3.currentPage = _this3.prevPage;
	            };
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'navigation', ref: 'navigation' });
	        }
	    }]);
	...
	var Pages = function (_React$Component2) {
	    ...
	    function Pages() {
	        ...
	        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(Pages).call(this));

	        _this4.animation = 'pages--normal';
	        return _this4;
	    }
	    ...
	    _createClass(Pages, [{
	        ...
	        key: 'config',
	        value: function config(name, component) {
	        ...
	        value: function push(name) {
	            ...
	            page.classList.add();
	            (0, _reactDom.render)(this.components[name], page);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Content = function (_React$Component) {
	    ...
	    _createClass(Content, [{
	        ...
	        key: 'hideInfinitScroll',
	        value: function hideInfinitScroll() {
	        ...
	        value: function componentDidMount() {
	            ...
	            if (this.props.pullToRefresh) {
	                this.pullToRefresh = new phonepack.PullToRefresh(this.refs.content, {}, function () {
	                    _this2.props.pullToRefresh();
	                });
	            }

	            if (this.props.infiniteScroll) {
	                this.infiniteScroll = new phonepack.InfiniteScroll(this.refs.content, {}, function () {
	                    _this2.props.infiniteScroll();
	                });
	            }
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var contentPadding = _props.contentPadding;
	            ...
	            return _react2.default.createElement(
	                'section',
	                _extends({ className: cls }, other, { ref: 'content' }),
	                this.props.children
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HeaderTitle = exports.HeaderButton = exports.SubHeader = exports.Header = undefined;
	...
	var SubHeader = function (_React$Component2) {
	    ...
	    _createClass(SubHeader, [{
	        ...
	        value: function render() {
	            ...
	            var other = _objectWithoutProperties(_props, ['className', 'headerShadow']);

	            var cls = (0, _classnames2.default)('sub-header', {
	...
	var HeaderButton = function (_React$Component3) {
	    _inherits(HeaderButton, _React$Component3);
	...
	var HeaderTitle = function (_React$Component4) {
	    _inherits(HeaderTitle, _React$Component4);

	    function HeaderTitle() {
	        _classCallCheck(this, HeaderTitle);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(HeaderTitle).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FooterTitle = exports.FooterButton = exports.SubFooter = exports.Footer = undefined;
	...
	var Footer = function (_React$Component) {
	    ...
	    _createClass(Footer, [{
	        ...
	        value: function render() {
	            ...
	            var cls = (0, _classnames2.default)('footer', className);
	...
	var SubFooter = function (_React$Component2) {
	    _inherits(SubFooter, _React$Component2);

	    function SubFooter() {
	        _classCallCheck(this, SubFooter);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SubFooter).apply(this, arguments));
	    }
	    ...
	    _createClass(SubFooter, [{
	        ...
	        value: function render() {
	            ...
	            var cls = (0, _classnames2.default)('sub-footer', className);
	...
	var FooterButton = function (_React$Component3) {
	    _inherits(FooterButton, _React$Component3);

	    function FooterButton() {
	        _classCallCheck(this, FooterButton);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FooterButton).apply(this, arguments));
	    }
	...
	var FooterTitle = function (_React$Component4) {
	    _inherits(FooterTitle, _React$Component4);

	    function FooterTitle() {
	        _classCallCheck(this, FooterTitle);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FooterTitle).apply(this, arguments));
	    }

	    _createClass(FooterTitle, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	...
	var Button = function (_React$Component) {
	    ...
	    _createClass(Button, [{
	        ...
	        value: function render() {
	            ...
	            var className = _props.className;
	            var fab = _props.fab;
	            var fabFloating = _props.fabFloating;
	            var children = _props.children;
	            var icon = _props.icon;
	            var ripple = _props.ripple;

	            var other = _objectWithoutProperties(_props, ['className', 'fab', 'fabFloating', 'children', 'icon', 'ripple']);

	            var cls = (0, _classnames2.default)('button', className, {
	                'button--fab': fab,
	...
	var Icon = function (_React$Component) {
	    ...
	    _createClass(Icon, [{
	        ...
	        value: function render() {
	            ...
	            var other = _objectWithoutProperties(_props, ['className', 'name']);

	            var cls = (0, _classnames3.default)('icon', 'mdi', className, _defineProperty({}, 'mdi-' + name, name));

	            return _react2.default.createElement('i', _extends({ className: cls }, other));
	        }
	    }]);
	...
	var List = function (_React$Component) {
	    ...
	    _createClass(List, [{
	        ...
	        value: function render() {
	            ...
	            var cls = (0, _classnames2.default)('list', className);
	...
	var ListItem = function (_React$Component2) {
	    ...
	    _createClass(ListItem, [{
	        ...
	        value: function render() {
	            ...
	            var other = _objectWithoutProperties(_props2, ['className', 'ripple', 'children']);

	            var cls = (0, _classnames2.default)('list__item', className, {
	                'ripple': ripple
	            });
	...
	var Input = function (_React$Component) {
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            ...
	            var cls = (0, _classnames2.default)('text-field__input', className);

	            return _react2.default.createElement('input', _extends({ className: cls }, other));
	        }
	    }]);
	...
	var Row = function (_React$Component) {
	    ...
	    _createClass(Row, [{
	        ...
	        value: function render() {
	            ...
	            var cls = (0, _classnames2.default)('row', className);
	...
	var Cell = function (_React$Component2) {
	    ...
	    _createClass(Cell, [{
	        ...
	        value: function render() {
	            ...
	            var cls = (0, _classnames2.default)('cell', className);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostList = __webpack_require__(199);
	...
	var Home = function (_Container) {
	    _inherits(Home, _Container);
	    ...
	    function Home() {
	        ...
	        _this.getState = function () {
	            return {
	                ...
	                notifications: this.store.getState().notifications.filter(function (notification) {
	    ...
	    _createClass(Home, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            socket.on("newNotification/" + window.currentUser._id, function (err, data) {
	                _this2.dispatch(_actions2.default.getNotifications());
	            });

	            this.dispatch(_actions2.default.getNotifications());
	            this.dispatch(_actions2.default.getPosts(function () {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _phonepack.Button,
	                                { icon: true, ripple: true, onClick: this.toggleMenu.bind(this) },
	                                _react2.default.createElement(_phonepack.Icon, { name: "menu" })
	                            )
	                        ),
	                        _react2.default.createElement(
	                            _phonepack.HeaderTitle,
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _phonepack.Button,
	                                { icon: true, ripple: true, onClick: this.pushPage.bind(this, 'mainNav', 'Notifications', null, 'pages--slide-left') },
	                                _react2.default.createElement(_phonepack.Icon, { name: "bell-outline" }),
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: { badge: true, 'bg-red': true, hide: this.state.notifications.length == 0 } },
	                    ...
	                    _react2.default.createElement(
	                        _phonepack.Content,
	                        {
	                            ...
	                            pullToRefresh: function pullToRefresh() {
	                                return _this3.dispatch(_actions2.default.getPosts(function () {
	                                    return _this3.hidePullToRefresh();
	                                }));
	                            },
	                            infiniteScroll: function infiniteScroll() {
	                                return _this3.dispatch(_actions2.default.getPosts(function () {
	                                    return _this3.hideInfinitScroll();
	                                }));
	                            }
	                        },
	                    ...
	                    _react2.default.createElement(
	                        _phonepack.Button,
	                        { fab: true, fabFloating: true, className: "bg-blue text-white", onClick: this.pushPage.bind(this, 'mainNav', 'Compose', null, 'pages--slide-up') },
	                        _react2.default.createElement(_phonepack.Icon, { name: "pencil" })
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostItem = __webpack_require__(200);
	    ...
	    _createClass(PostList, [{
	        ...
	        value: function render() {
	            var items = this.props.posts.map(function (post, index) {
	                return _react2.default.createElement(_PostItem2.default, { key: post._id, post: post });
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostItem = function (_Container) {
	    _inherits(PostItem, _Container);
	    ...
	    _createClass(PostItem, [{
	        ...
	        value: function likePost() {
	            this.dispatch(_actions2.default.likePost(this.props.post, function () {}));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'li',
	                { className: post.quotebg, style: style },
	                _react2.default.createElement('div', { className: 'image-overlay' }),
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    '   ',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { className: btnClass, onClick: this.likePost.bind(this) },
	                                _react2.default.createElement('i', { className: 'icon mdi mdi-heart-outline' })
	                            ),
	                            _react2.default.createElement(
	                                'span',
	                                null,
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { className: 'button ripple button--icon comment', onClick: this.openCommentsPage.bind(this) },
	                                _react2.default.createElement('i', { className: 'icon mdi mdi-comment-outline' })
	                            ),
	                            _react2.default.createElement(
	                                'span',
	                                null,
...
/***/ function(module, exports) {
	...
	exports.default = {
	        ...
	        return function (dispatch) {
	            openFB.api({
	                ...
	                success: function success(results) {
	                    var friendsIds = results.data.map(function (f) {
	                        return f.id;
	                    }).concat(window.currentUser.facebook_id);
	                    socket.emit('getPosts', friendsIds, function (err, posts) {
	                        dispatch({
	                            type: 'GET_POSTS',
	                            posts: posts
	                        });
	    ...
	    createPost: function createPost(post, cb) {
	        return function (dispatch) {
	            socket.emit('createPost', post, function (err, newPost) {
	                dispatch({
	                    type: 'CREATE_POST',
	                    post: newPost
	                });
	    ...
	    likePost: function likePost(post, cb) {
	        return function (dispatch) {
	    ...
	    createComment: function createComment(post, text) {
	        return function (dispatch) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Compose = function (_Container) {
	    ...
	    function Compose() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Compose).call(this));
	    ...
	    _createClass(Compose, [{
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            _get(Object.getPrototypeOf(Compose.prototype), "componentDidMount", this).call(this);
	            var textCompose = this.refs.textCompose;
	            $(textCompose).elastic();
	        }
	    }, {
	        key: "bindTextCompose",
	        value: function bindTextCompose(e) {
	            this.setState({
	        ...
	        value: function changePostTexture(e) {
	            if (this.textureIndex === this.textures.length - 1) this.textureIndex = -1;
	            this.textureIndex++;

	            var $postTexture = $(this.refs.postTexture);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FindImage = function (_Container) {
	    ...
	    _createClass(FindImage, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            _get(Object.getPrototypeOf(FindImage.prototype), 'componentDidMount', this).call(this);
	        }
	    }, {
	        key: 'find',
	        value: function find(e) {
	            ...
	            getWebImages(this.search).then(function (images) {
	                _this2.setState({
	                    images: images,
	                    loading: false
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comments = function (_Container) {
	    _inherits(Comments, _Container);
	    ...
	    function Comments(props) {
	        ...
	        _this.getState = function () {
	            return {
	                post: _this.store.getState().posts.filter(function (post) {
	    ...
	    _createClass(Comments, [{
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            _get(Object.getPrototypeOf(Comments.prototype), "componentDidMount", this).call(this);
	            this.dispatch(_actions2.default.getComments(this.state.post));
	        }
	    }, {
	        key: "createComment",
	        value: function createComment() {
	            this.dispatch(_actions2.default.createComment(this.props.post, this.refs.comment.value));
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "section",
	                    { className: "content has-footer" },
	                    _react2.default.createElement(_PostBox2.default, { post: this.state.post }),
	                    _react2.default.createElement(_CommentBox2.default, { post: this.state.post })
	                ),
	                _react2.default.createElement(
	                    "footer",
	                    { className: "footer" },
	                    _react2.default.createElement(
	                        "div",
	                        { className: "text-field", style: { width: '100%', 'marginLeft': '16px' } },
	                        _react2.default.createElement("input", { type: "text", className: "text-field__input", placeholder: "Escreva seu comentário", ref: "comment" }),
	                        _react2.default.createElement("div", { className: "text-field__border" })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        ...
	                        _react2.default.createElement(
	                            "button",
	                            { className: "button ripple button--icon", onClick: this.createComment.bind(this) },
	                            _react2.default.createElement("i", { className: "icon mdi mdi-send" })
	                        )
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostBox = function (_Container) {
	    _inherits(PostBox, _Container);

	    function PostBox() {
	        _classCallCheck(this, PostBox);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(PostBox).call(this));
	    }

	    _createClass(PostBox, [{
	        key: 'closePage',
	        value: function closePage() {
	            _phonepack.Navigation.closeCurrentPage('mainNav');
	        }
	    }, {
	        key: 'likePost',
	        value: function likePost() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'button button--icon ripple', onClick: this.closePage.bind(this) },
	                            _react2.default.createElement('i', { className: 'icon mdi mdi-arrow-left' })
	                        ),
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'button ripple button--icon shared', style: { float: 'right' } },
	                            _react2.default.createElement('i', { className: 'icon mdi mdi-share-variant' })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = function (_Container) {
	    _inherits(CommentBox, _Container);
	    ...
	    _createClass(CommentBox, [{
	        ...
	        value: function render() {
	            ...
	            if (this.props.post.listComments) {
	                var comments = this.props.post.listComments.map(function (comment) {
	                    return _react2.default.createElement(_CommentItem2.default, { key: comment._id, comment: comment });
	                });
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentItem = function (_Container) {
	    _inherits(CommentItem, _Container);

	    function CommentItem() {
	        _classCallCheck(this, CommentItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(CommentItem).call(this));
	    }
	    ...
	    _createClass(CommentItem, [{
	        ...
	        value: function render() {
	            ...
	            var btnClass = (0, _classnames2.default)(classes);

	            var btnLike = (0, _classnames2.default)({
	                'button': true,
	                'ripple': true,
	                'button--icon': true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notifications = function (_Container) {
	    _inherits(Notifications, _Container);
	    ...
	    _createClass(Notifications, [{
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            _get(Object.getPrototypeOf(Notifications.prototype), "componentDidMount", this).call(this);
	            this.dispatch(_actions2.default.readNotifications());
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "button",
	                            { className: "button button--icon ripple", onClick: this.closeCurrentPage.bind(this, 'mainNav') },
	                            _react2.default.createElement("i", { className: "icon mdi mdi-arrow-left" })
	                        )
	                    ),
	                    _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        this.state.notifications.map(function (notification) {
	                            return _react2.default.createElement(
	                                "li",
	                                { className: "list__item ripple", key: notification._id },
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: "list__content" },
